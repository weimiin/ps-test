...
(async () => {
  ...
  const stripe = Stripe('pk_live_GRfb9E6zcrgEEnTaWp7u29vt003Y7g5SrT');
  ...
  const elements = stripe.elements({
    fonts: [
      {
        cssSrc: 'https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i,600,600i,700,700i&display=swap',
      },
    ],
  });
